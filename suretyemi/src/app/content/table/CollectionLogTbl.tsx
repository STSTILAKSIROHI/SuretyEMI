        ...
        <>
            ...
            <div className='bg-white rounded-3'>
                <Datatable
                    ...
                    columns={CollectionLogCol as any}
                    pagination={true}
                    isLoader={false}
                    tableNm={" Collection History / Transaction Table"}
                    isSearchBar={true}
...
export default CollectionLogTbl
